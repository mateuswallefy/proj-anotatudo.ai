...
export function Logo({ className = "h-8", white = false, iconOnly = false }: LogoProps) {
  ...
  if (iconOnly) {
    return (
      ...
      >
        ...
        {/* Círculo - laranja CAIXA */}
        <circle cx="65" cy="45" r="10" fill="#F39200"/>
      </svg>
    );
  }
  if (white) {
  ...
  return (
    ...
    >
      ...
      <text 
        ...
        style={{ fontSize: '36px', fontWeight: 'bold', fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '-1.5px' }}
      >
        AnotaTudo<tspan fill="#F39200">.AI</tspan>
      </text>
    </svg>
  );
}
